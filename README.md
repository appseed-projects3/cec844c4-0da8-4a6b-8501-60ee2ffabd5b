...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-03 12:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cec844c4-0da8-4a6b-8501-60ee2ffabd5b.git
$ cd cec844c4-0da8-4a6b-8501-60ee2ffabd5b
```
